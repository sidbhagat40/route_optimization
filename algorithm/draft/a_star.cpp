...
int main() {
    // Example usage
    GeoCoordinate depot(26.466284587413128, 73.11177376078871); // Depot location
    std::vector<Delivery> deliveries = {
        {{26.23837109674883, 73.00619526985768}, {15, 17}, false}, // Delivery 1 with time window 3 PM - 5 PM
        {{26.219393744183503, 73.04135354904878}, {0, 0}, false}, // Delivery 2 without time window
        {{26.47520225789069, 73.11708515743788}, {0, 0}, false}, // Delivery 3 without time window
        {{26.476457578760822, 73.11990278504588}, {0, 0}, false}, // Delivery 4 without time window
        {{26.474167116435424, 73.11186391712427}, {0, 0}, false}  // Delivery 5 without time window
    };
